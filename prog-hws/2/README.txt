...
For the problem 1, after choosing the primitive, ratio and color, click the "Draw Fractal" button to show the result. 
For the problem 2, first of all, input the radius value and drive's score, then click the "Draw Wheel" button to get the final wheel picture.
